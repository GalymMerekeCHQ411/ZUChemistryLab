const elements = {
  ...
  Rb: 85.468, Sr: 87.62, Y: 88.906, Zr: 91.224, Nb: 92.906, Mo: 95.95, Tc: 98, Ru: 101.07, Rh: 102.91, Pd: 106.42, Ag: 107.87, Cd: 112.41,
  In: 114.82, Sn: 118.71, Sb: 121.76, Te: 127.60, I: 126.90, Xe: 131.29,
  Cs: 132.91, Ba: 137.33, La: 138.91, Ce: 140.12, Pr: 140.91, Nd: 144.24, Pm: 145, Sm: 150.36, Eu: 151.96, Gd: 157.25, Tb: 158.93, Dy: 162.50,
...
function calculateMass() {
  ...
  try {
    let parsed = parseFormula(f);
    let mass = 0;
    for (let el in parsed) {
      if (!elements[el]) throw new Error("Неизвестный элемент: " + el);
      mass += elements[el] * parsed[el];
    }
    document.getElementById("result").textContent = "Молекулярная масса " + f + " = " + mass.toFixed(3);
  } catch (e) {
